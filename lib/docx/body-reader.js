    ...
    var xmlElementReaders = {
            ...
            if (isDeleted) {
                ...
                return ReadResult.map(
                    ...
                    function(properties, children) {
                        ...
                        // Mark paragraphs within BIBLIOGRAPHY fields for easy detection
                        if (isInBibliographyField()) {
        ...
        "w:sdt": function(element) {
            ...
            return contentResult.map(function(content) {
                // Check if this is a bibliography SDT - mark it for easy detection by web app
                if (citationDetector.isBibliographySdt(element)) {
                ...
                // Check if this is a citation SDT
                if (citationDetector.isCitationSdt(element)) {
